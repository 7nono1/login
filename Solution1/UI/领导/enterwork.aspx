...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height:28px; margin-left:30px; margin-top:10px;">
        <a href="Default.aspx" style="text-decoration:none; color:cyan;">首页</a>><a href="enterwork.aspx" style="text-decoration:none;color:cyan;">录入考勤</a>
    </div>
    <div style="height: 785px">
    <asp:Repeater ID="rptCourse" runat="server" OnItemCommand="rptCourse_ItemCommand" DataSourceID="SqlDataSource1">
        <HeaderTemplate>
